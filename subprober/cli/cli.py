...
class CLI:
    ...
    def cli(self):
        try:
            ...
            parser.add_argument("-das", "--disable-auto-save", action="store_true", default=False)
            ...
            parser.add_argument("-rtl", "--rate-limit", type=int, default=150)
            ...
            parser.add_argument("-scp", "--system-chrome-path", type=str, default=None)
            ...
            parser.add_argument("-no-fpg", "--no-full-page", action="store_true")
            parser.add_argument("-pdf", "--save-pdf", action="store_true")
            parser.add_argument("-sid", "--screenshot-idle", default=1, type=int)
            parser.add_argument("-hos", "--headless-options",type=str, default=None)
            parser.add_argument("-icb", "--include-bytes", action="store_true")
            parser.add_argument("-body", "--body", type=str, default=None)
            parser.add_argument("-resolvers", "--resolvers", type=str,default="8.8.8.8,1.1.1.1")
            ...
            self.logger.warn(f"Exception occured in the cli module due to: {e}, {type(e)}")
            exit(1)