...
class Help:
    ...
    def display_help(self):
        ...
        description = Text(
            ...
            "with Asynchronous httpx client support ⚡",
        ...
        self._print_table_section(
            ...
            [
                ...
                ("-resume, --resume", "specify the resume filename generated by the subprober to continue the scan (-resume resume_Djjfos.cfg)"),
        ...
        self._print_table_section(
            ...
            [
                ...
                ("-body, --body", "post body to include in the http request and support all post body types (ex: -body 'username=admin&password=password')"),
                ("-resolvers, --resolvers", "custom DNS resolver for dns resolution and supports comma-separated (ex -resolvers 8.8.8.8,1.1.1.1)")
            ]
        )
        ...
        self._print_table_section(
            ...
            ["Flag", "Description"],
            [
                ("-dhp, --disable-http-probe", "disable subprober from fallback to http scheme (default: disabled)"),
        ...
        self._print_table_section(
            ...
            [
                ...
                ("-no-fpg , --no-full-page", "disable saving screenshot in full page"),
        ...
        self._print_table_section(
            ...
            [
                ...
                ("-d, --delay", "set a delay in seconds before sending each request (default: None)"),
        ...
        self._print_table_section(
            ...
            ["Flag", "Description"],
            [
                ("-up, --update", "update subprober to the latest version (uv tool required to be installed)"),
    ...
    def _print_section(self, header, content):
    ...
    def _print_table_section(self, header, columns, rows):
        """Print a table section with header, columns and rows"""
        self.console.print(
            Text(header, style="bold #4682B4") + Text(":", style="bold white"),
            style="bold white"
        )
